...
class WebService {
    ...
    func downloadNews(url: URL, completion: @escaping  ([News]?) -> () ) { //haberi url'den indirmek için fonksiyn yazdık bu fonksiyonun tamamlama bloğunu da News struct'ı ile yapıcaz. yani gelen url'deki veriler News.swift dosyası ile tanımlanacak
